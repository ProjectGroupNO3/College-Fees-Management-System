...
<body>
  ...
  <br>
<form action="admissionprocess.php" method="post">
  <section class="dropdown">
    ...
    <div class="container">
      ...
      <div class="col-sm-12 col-md-3 col-lg-3 col-12 m-auto text-center">
        ...
        <div class="col-sm-12 col-md-3 col-lg-3 col-12 m-auto text-center">
          <h4><input type="text" class="dop" name="department"></h4>
        </div>
        <div class="col-sm-12 col-md-3 col-lg-3 col-12 m-auto text-center">
        </div>
  ...
  <section class="dropdown">
    <div class="container">
      ...
      <div class="col-sm-12 col-md-3 col-lg-3 col-12 m-auto text-center">
        ...
        <div class="col-sm-12 col-md-3 col-lg-3 col-12 m-auto text-center">
          <h4><input type="text" class="dop" name="branch"></h4>
        </div>
        <div class="col-sm-12 col-md-3 col-lg-3 col-12 m-auto text-center">
        </div>
  ...
  <section class="dropdown">
    <div class="container">
      ...
      <div class="col-sm-12 col-md-3 col-lg-3 col-12 m-auto text-center">
        ...
        <div class="col-sm-12 col-md-3 col-lg-3 col-12 m-auto text-center">
          <h4><input type="text" class="dop" name="category"></h4>
        </div>
        <div class="col-sm-12 col-md-3 col-lg-3 col-12 m-auto text-center">
        </div>
